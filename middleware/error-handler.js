...
const errorHandlerMiddleware = (err, req, res, next) => {
  ...
  //as email is unique.so if user try to register with same email 2nd time
  if (err.code && err.code === 11000) {
    //without Object.keys(err.keyValue) it will show like this Object 
  ...
  //when the id syntax does not match what the mongoose is looking for
